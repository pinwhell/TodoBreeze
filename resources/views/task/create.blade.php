    ...
    <div class="container max-w-xl mx-auto mt-4">
        <form method="POST" action="{{ route('task.store') }}">
            ...
            <div class="mt-4">
                ...
                <input type="date" name="due_date" id="due_date" class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
